...
- **Périmètre initial** : SEOPress (activation du sitemap Google News, nom de publication, types de contenu inclus), Yoast SEO (sitemaps XML, séparateur de titres), WooCommerce (avis produits, codes promo, gestion des stocks). Toutes les clés d'options ont été relevées dans les sources des plugins, jamais devinées.

	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--m)">
				...
				<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-white-color has-text-color wp-element-button" style="border-radius:4px;border-width:1px;border-color:rgba(250,250,250,0.6)">Voir les tarifs</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->

			<!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|m"},"padding":{"top":"var:preset|spacing|s","bottom":"var:preset|spacing|s","right":"var:preset|spacing|s","left":"var:preset|spacing|s"},"blockGap":"var:preset|spacing|s"},"border":{"radius":"8px","color":"rgba(212,163,115,0.3)","width":"1px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
			<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--m);padding:var(--wp--preset--spacing--s);border-radius:8px;border:1px solid rgba(212,163,115,0.3)">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			<!-- wp:group {"style":{"border":{"radius":"12px"},"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|m","left":"var:preset|spacing|m"}}},"style":{"color":{"background":"rgba(255,255,255,0.08)"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="border-radius:12px;padding:var(--wp--preset--spacing--m);background-color:rgba(255,255,255,0.08)">
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m)">
	...
	<p class="has-text-align-center has-secondary-color has-text-color has-s-font-size" style="font-weight:600;letter-spacing:0.12em;text-transform:uppercase">Nos prestations</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			<!-- wp:group {"style":{"border":{"radius":"8px","width":"1px","color":"rgba(47,66,93,0.1)"},"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|s","left":"var:preset|spacing|s"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="border-radius:8px;border:1px solid rgba(47,66,93,0.1);padding:var(--wp--preset--spacing--m) var(--wp--preset--spacing--s)">

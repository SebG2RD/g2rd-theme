		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<div class="wp-block-group is-style-card">
				...
				<div class="wp-block-columns is-not-stacked-on-mobile">
					<!-- wp:column {"style":{"border":{"color":"var:custom|color|border","width":"1px","radius":"var:custom|radius|m"},"spacing":{"padding":{"top":"var:preset|spacing|xs","bottom":"var:preset|spacing|xs","left":"var:preset|spacing|xs","right":"var:preset|spacing|xs"}}}} -->
					<div class="wp-block-column has-border-color" style="border-color:var(--wp--custom--color--border);border-width:1px;border-radius:var(--wp--custom--radius--m);padding-top:var(--wp--preset--spacing--xs);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--xs);padding-left:var(--wp--preset--spacing--xs)"><!-- wp:paragraph {"textColor":"primary","style":{"typography":{"fontSize":"1.6rem","fontWeight":"800","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} --><p class="has-primary-color has-text-color" style="margin-top:0;margin-bottom:0;font-size:1.6rem;font-weight:800;line-height:1">12</p><!-- /wp:paragraph -->
					...
					<!-- /wp:column -->
					<!-- wp:column {"style":{"border":{"color":"var:custom|color|border","width":"1px","radius":"var:custom|radius|m"},"spacing":{"padding":{"top":"var:preset|spacing|xs","bottom":"var:preset|spacing|xs","left":"var:preset|spacing|xs","right":"var:preset|spacing|xs"}}}} -->
					<div class="wp-block-column has-border-color" style="border-color:var(--wp--custom--color--border);border-width:1px;border-radius:var(--wp--custom--radius--m);padding-top:var(--wp--preset--spacing--xs);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--xs);padding-left:var(--wp--preset--spacing--xs)"><!-- wp:paragraph {"textColor":"danger","style":{"typography":{"fontSize":"1.6rem","fontWeight":"800","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} --><p class="has-danger-color has-text-color" style="margin-top:0;margin-bottom:0;font-size:1.6rem;font-weight:800;line-height:1">2</p><!-- /wp:paragraph -->
				...
				<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--xs)">
					<!-- wp:group {"style":{"spacing":{"padding":{"top":"0.55rem","bottom":"0.55rem"}},"border":{"bottom":{"color":"var:custom|color|border","width":"1px"}}},"layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"center","flexWrap":"nowrap"}} --><div class="wp-block-group" style="border-bottom-color:var(--wp--custom--color--border);border-bottom-width:1px;padding-top:0.55rem;padding-bottom:0.55rem"><!-- wp:paragraph {"textColor":"primary","style":{"typography":{"fontSize":"0.9rem","fontWeight":"600"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} --><p class="has-primary-color has-text-color" style="margin-top:0;margin-bottom:0;font-size:0.9rem;font-weight:600">boutique-floralie.fr</p><!-- /wp:paragraph -->

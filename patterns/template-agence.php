...
<!-- Clients / Partenaires -->
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|l","bottom":"var:preset|spacing|l","right":"var:preset|spacing|m","left":"var:preset|spacing|m"}},"color":{"background":"#F5F4F2"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--l);padding-bottom:var(--wp--preset--spacing--l);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m);background-color:#F5F4F2">
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m);background-color:#F5F4F2">
	...
	<p class="has-text-align-center has-secondary-color has-text-color has-s-font-size" style="font-weight:600;letter-spacing:0.12em;text-transform:uppercase">Portfolio</p>
	<!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|s","left":"var:preset|spacing|s"}},"border":{"top":{"color":"var:preset|color|secondary","width":"4px"},"radius":"0 0 8px 8px"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding:var(--wp--preset--spacing--m) var(--wp--preset--spacing--s);border-top:4px solid var(--wp--preset--color--secondary);border-radius:0 0 8px 8px">
				<!-- wp:heading {"level":3,"textColor":"secondary","style":{"typography":{"fontSize":"3rem","fontWeight":"900","lineHeight":"1"}}} --><h3 class="wp-block-heading has-secondary-color has-text-color" style="font-size:3rem;font-weight:900;line-height:1">01</h3><!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|s","left":"var:preset|spacing|s"}},"border":{"top":{"color":"var:preset|color|secondary","width":"4px"},"radius":"0 0 8px 8px"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding:var(--wp--preset--spacing--m) var(--wp--preset--spacing--s);border-top:4px solid var(--wp--preset--color--secondary);border-radius:0 0 8px 8px">
				<!-- wp:heading {"level":3,"textColor":"secondary","style":{"typography":{"fontSize":"3rem","fontWeight":"900","lineHeight":"1"}}} --><h3 class="wp-block-heading has-secondary-color has-text-color" style="font-size:3rem;font-weight:900;line-height:1">02</h3><!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|s","left":"var:preset|spacing|s"}},"border":{"top":{"color":"var:preset|color|secondary","width":"4px"},"radius":"0 0 8px 8px"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding:var(--wp--preset--spacing--m) var(--wp--preset--spacing--s);border-top:4px solid var(--wp--preset--color--secondary);border-radius:0 0 8px 8px">
				<!-- wp:heading {"level":3,"textColor":"secondary","style":{"typography":{"fontSize":"3rem","fontWeight":"900","lineHeight":"1"}}} --><h3 class="wp-block-heading has-secondary-color has-text-color" style="font-size:3rem;font-weight:900;line-height:1">03</h3><!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|s","left":"var:preset|spacing|s"}},"border":{"top":{"color":"var:preset|color|secondary","width":"4px"},"radius":"0 0 8px 8px"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding:var(--wp--preset--spacing--m) var(--wp--preset--spacing--s);border-top:4px solid var(--wp--preset--color--secondary);border-radius:0 0 8px 8px">
				<!-- wp:heading {"level":3,"textColor":"secondary","style":{"typography":{"fontSize":"3rem","fontWeight":"900","lineHeight":"1"}}} --><h3 class="wp-block-heading has-secondary-color has-text-color" style="font-size:3rem;font-weight:900;line-height:1">04</h3><!-- /wp:heading -->

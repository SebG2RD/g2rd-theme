<?php
/**
 * Title: Template Artisan / Prestataire local
 * Slug: g2rd-theme/template-artisan
 * Description: Page d'accueil pour artisan, plombier, électricien, menuisier — zone d'intervention, devis rapide
 * Categories: featured, banner
 * Keywords: artisan, plombier, électricien, menuisier, devis, intervention
 * Viewport Width: 1400
...
<div class="wp-block-group alignfull has-primary-background-color has-background" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
			...
			<p class="has-secondary-color has-text-color has-s-font-size" style="font-weight:600;letter-spacing:0.12em;text-transform:uppercase">🔧 Artisan qualifié · Devis gratuit</p>
			<!-- /wp:paragraph -->
			...
			<h1 class="wp-block-heading has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--xs);font-size:clamp(2.2rem, 4.5vw, 3.8rem);line-height:1.1;font-weight:800">Votre artisan de confiance<br><mark style="background-color:rgba(0,0,0,0)" class="has-inline-color has-secondary-color">intervention rapide</mark></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"textColor":"white","style":{"typography":{"lineHeight":"1.75","fontSize":"1.1rem"},"spacing":{"margin":{"top":"var:preset|spacing|s"}}}} -->
			<p class="has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--s);font-size:1.1rem;line-height:1.75">Plomberie, électricité, menuiserie. Devis gratuit sous 24h, intervention dans votre commune et les alentours. Certifié RGE et assuré décennale.</p>
			<!-- /wp:paragraph -->

			<!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|s"},"margin":{"top":"var:preset|spacing|m"}}}} -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			...
			<figure class="wp-block-image size-large" style="border-radius:1rem"><img alt="Artisan en intervention" /></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--xl);padding-right:var(--wp--preset--spacing--m);padding-left:var(--wp--preset--spacing--m);background-color:var(--wp--preset--color--cream)">
	...
	<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|s","bottom":"var:preset|spacing|m"}}}} -->
	<p class="has-text-align-center" style="margin-top:var(--wp--preset--spacing--s);margin-bottom:var(--wp--preset--spacing--m)">Nous intervenons dans un rayon de 30 km autour de votre commune. Ajoutez ici les villes et zones couvertes.</p>
	<!-- /wp:paragraph -->

	<!-- wp:group {"style":{"border":{"radius":"8px"},"spacing":{"padding":{"top":"var:preset|spacing|m","bottom":"var:preset|spacing|m","right":"var:preset|spacing|m","left":"var:preset|spacing|m"}}},"backgroundColor":"primary","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
	<div class="wp-block-group has-primary-background-color has-background" style="border-radius:8px;padding:var(--wp--preset--spacing--m)">
		<!-- wp:paragraph {"textColor":"white","style":{"typography":{"fontSize":"0.95rem","fontWeight":"600"}}} --><p class="has-white-color has-text-color" style="font-size:0.95rem;font-weight:600">Paris · Versailles · Boulogne · Neuilly · Saint-Cloud · Issy · Meudon · Sèvres · Châtillon · Montrouge · Bagneux · Malakoff</p><!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
...
<!-- FAQ -->
<!-- wp:pattern {"slug":"g2rd-theme/section-faq"} /-->
